...
export class SpriteCreator {
	...
	createAnimatedSprite(textures: Array<Texture>, layer: Layer, oversize?: number): AnimatedSprite {
	...
	private setSpriteProperties(sprite: Sprite | AnimatedSprite, layer: Layer, oversize?: number): void {
